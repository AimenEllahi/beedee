  ...
  return (
    <div className='outer-container-third'>
      <div className='image-container'>
            <img style={{
                width: "100%",
            }} src="/goedwhite2.png" alt="Your Image"/>
        <div className='text-container-bottom-left'>
            ...
            <p style={{padding: ".5vw"}}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Adipisci nisi, rem culpa necessitatibus  
                suscipit quia maxime alias fuga recusandae iure officiis temporibus odio.
            </p>
